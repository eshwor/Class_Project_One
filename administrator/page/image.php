<?php
$galId  =  $_GET['galId'];
$result   =  $funObj -> ImageListPage($galId);
?>
<table width="960" cellpadding="1" cellspacing="1" border="0">
  <tr>
    <td colspan="5"><h2>Gallery Image  Management Section </h2></td>
  </tr>
  <tr>
	...
	<a href="index.php?_page=gallery">Back to Gallery</a>
	
	<a href="index.php?_page=add_edit_image&action=add&galId=<?php echo $galId; ?>" title="Add">
  ...
  <br />
  <div align="left" style="font-weight:bold;padding-left:20px;">
  <?php
...
?>
  ...
  ?>
    ...
    <td><a href="index.php?_page=add_edit_image&action=edit&id=<?php echo $row['id']; ?>&galId=<?php echo $galId; ?>" title="Edit"><img src="images/edit.gif" border="0" title="Edit" alt="Edit" /></a></td>
    <td><a href="page/act_image.php?action=delete&id=<?php echo $row['id']; ?>&galId=<?php echo $galId; ?>" title="Delete" onclick="return confirm('Are you sure you want to delete this data');"><img src="images/delete.png" border="0" title="Delete" alt="Delete" /></a></td>
  </tr>
